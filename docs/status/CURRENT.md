...
**Updated:** 2026-09-26 (R1-B1/B2 correction published; replacement native run pending).
...
**Current checkpoint:** Phase 1G.2a runtime/trust foundation, `awaiting_ci`, R1-B1/B2 correction published; final native production evidence pending, on `feature/phase-1g-branches-runtime`, draft [PR #17](https://github.com/Caldwell-41/Renpy-editor/pull/17).
...
**Final R1-B1/B2 correction candidate:** `07f23b61d46511848d2b09db57ba1d5a696cabe0`, tree `614931107db78f61c5b864a099ca2737ab546bd8`. Replacement [run 36144974132](https://github.com/Caldwell-41/Renpy-editor/actions/runs/36144974132), attempt 1, is pending at inspection. Earlier correction run `36144599144` on `fd4ffca` is in progress/superseded; preserve its actual outcome. Final targeted runtime 18/2 ignored and repository/format/whitespace checks passed; exact-candidate quality `36144979086` passed. No final native pass claimed; manual resume per HANDOVER.
