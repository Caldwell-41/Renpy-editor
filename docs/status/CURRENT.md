...
**Selected checkpoint:** F4 settled-selection correction `review_ready`; browser and native evidence remain open.
...
**Evidence:** [F4 correction ledger 7.26](../tasks/active/phase-1f-save-correction.md#726-f4-settled-selection-correction--review-ready); prior findings in 7.25 and build evidence in 7.23–7.24.
...
pass, but the real-browser regression has not run on a browser-equipped host yet.
F1 core safeguards and F2/F3 remain covered; F4 requires review and native evidence.
