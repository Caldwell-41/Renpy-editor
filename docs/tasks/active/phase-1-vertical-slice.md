...
and 1G.2b. 1G.1 is `review_ready`; 1G.2a is `in_progress` with R1-B1/B2
corrected locally and replacement native evidence pending; 1G.2b remains `not_started`. The 1G ledger records targeted evidence and deferred final native evidence. G1/R1/R2 prove shared flow, runtime/trust/process ownership,
